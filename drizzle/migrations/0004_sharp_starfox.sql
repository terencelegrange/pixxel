...
ALTER TABLE `users` ADD COLUMN IF NOT EXISTS `mfa_secret` text;--> statement-breakpoint
ALTER TABLE `users` ADD COLUMN IF NOT EXISTS `mfa_pending_secret` text;--> statement-breakpoint
