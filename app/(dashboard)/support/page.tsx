      ...
      <div className="mx-auto max-w-2xl">
        {submitted ? (
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-10 text-center shadow-sm">
            ...
            <h2 className="mt-4 text-lg font-semibold text-emerald-800">Request submitted!</h2>
            <p className="mt-2 text-sm text-emerald-700">
              Thank you — your request has been received and will be reviewed.
            </p>
            <button onClick={reset} className="mt-6 text-sm text-emerald-600 underline hover:text-emerald-800">
            ...
            <form onSubmit={handleSubmit} noValidate className="p-6 space-y-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="h-9 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
                >
