  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-auto max-w-2xl">
        {submitted ? (
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-10 text-center shadow-sm dark:border-emerald-800/50 dark:bg-emerald-950/20">
            ...
            <form onSubmit={handleSubmit} noValidate className="p-6 space-y-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="h-9 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
                >
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-700 dark:text-slate-300">
                  Description <span className="text-slate-400 font-normal dark:text-slate-500">(optional)</span>
                </label>
                <textarea
                  rows={5}
                  value={description}
                  ...
                  className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 resize-none dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500"
                />
              </div>
